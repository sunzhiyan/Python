...
cursor = db.cursor()
student_sql1 = "SELECT * FROM students WHERE id between 3 and 8"
classes_sql1 = "SELECT * FROM classes WHERE id between 3 and 8"
